...
function init() {
    ...
    let markerControl = new THREEx.ArMarkerControls(arToolkitContext, markerRoot1, {
        ...
        type: 'pattern', patternUrl: 'data/pattern-camila.patt',
    });
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('capa3.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('capa3.obj', function (group) {
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('capa4.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('capa4.obj', function (group) {
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('capa5.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('capa5.obj', function (group) {
